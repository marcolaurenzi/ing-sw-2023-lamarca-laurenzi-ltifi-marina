...
public class PersonalGoal0 extends PersonalGoal{
    ...
    public Matrix<Item> createpersonalGoal() {
        ...
        personalGoal.set(0,0,new Item(ColorEnum.PINK, "one"));
        personalGoal.set(0,2,new Item(ColorEnum.BLUE, "one"));
        personalGoal.set(1,4,new Item(ColorEnum.GREEN, "one"));
        personalGoal.set(2,3,new Item(ColorEnum.WHITE, "one"));
        personalGoal.set(3,1,new Item(ColorEnum.YELLOW, "one"));
        personalGoal.set(5,2,new Item(ColorEnum.LIGHTBLUE, "one"));
