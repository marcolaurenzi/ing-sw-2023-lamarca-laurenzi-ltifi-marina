...
public class PersonalGoal3 extends PersonalGoal{
    ...
    public Matrix<Item> createpersonalGoal() {
        ...
        personalGoal.set(0,4,new Item(ColorEnum.YELLOW, "one"));
        personalGoal.set(2,0,new Item(ColorEnum.LIGHTBLUE, "one"));
        personalGoal.set(2,2,new Item(ColorEnum.BLUE, "one"));
        personalGoal.set(3,3,new Item(ColorEnum.PINK, "one"));
        personalGoal.set(4,1,new Item(ColorEnum.WHITE, "one"));
        personalGoal.set(4,2,new Item(ColorEnum.GREEN, "one"));
