...
public class PersonalGoal4 extends PersonalGoal{
    ...
    public Matrix<Item> createpersonalGoal() {
        ...
        personalGoal.set(1,2,new Item(ColorEnum.LIGHTBLUE, "one"));
        personalGoal.set(3,1,new Item(ColorEnum.BLUE, "one"));
        personalGoal.set(3,2,new Item(ColorEnum.WHITE, "one"));
        personalGoal.set(4,4,new Item(ColorEnum.PINK, "one"));
        personalGoal.set(5,0,new Item(ColorEnum.YELLOW, "one"));
        personalGoal.set(5,3,new Item(ColorEnum.GREEN, "one"));
